...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.showArray = ["CXTimerViewController", "CXProtocolViewController", "CXObjectMapperViewController", "CXRuntimeViewController", "CXClassesViewController", "CXDesignViewController", "CXMVXViewController", "CXSnapKitViewController", "CXRxSwiftViewController"]
    }
